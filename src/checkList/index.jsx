...
//                             <div id="map"></div>
//                         </div>
//                         <Serach provincesObj={provincesObj}/>
//                     </div>
...
//     render(){
//         const {justName} = this.props
//         return(
//             <div>
//                 <button onClick={justName}>+1</button>
//             </div>
//         )
//     }
// }

// const MemoList = memo(function List(){console.log("111");return(<div><h2>111</h2></div>)});
// function List(){console.log("111");return(<div><h2>111</h2></div>)}

// class Bili extends PureComponent{
//     constructor(props){
//         super(props)
//         this.state = {
//             count: 0
...
//            <div>
//                <div>{count}</div>
//                <button onClick={e => this.changeNum()}>+</button>
//                <Child justName={e => this.changeNum()}/>
//                <MemoList />
//                <List />
//            </div>
//        )
